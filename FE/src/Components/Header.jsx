        ...
        <div className="flex h-16 items-center">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-transparent">
              <span className="text-[#000000]">ViVu</span>
        ...
        <div className="hidden md:flex items-center gap-3">
          {!isCheck ? (
            <>
              <Link
                to="/signin"
                className="text-l text-gray-600 hover:text-[#f97316] px-4 py-2"
              >
                Đăng nhập
              </Link>
              <Link
                to="/register"
                className="px-5 py-2 bg-gradient-to-r from-[#f97316] to-[#f59e0b] text-white rounded-full hover:shadow-lg hover:shadow-orange-200 transition-all"
              >
                Đăng ký
              </Link>
            </>
            ...
            <>
              {["provider", "admin"].includes(user.role) && (
                <Link
                  ...
                  className="flex items-center gap-1.5 px-4 py-2 bg-[#f0f4f8] text-[#1a1a2e] rounded-full hover:bg-[#f97316]/10 transition-colors"
                >
                  <MdOutlineDashboard />
                  Dashboard
                </Link>
