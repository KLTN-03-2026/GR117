    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-2xl bg-white p-7 text-center shadow-2xl">
        ...
        <p className="mb-6 text-[13px] text-gray-500">
          Xóa lịch khởi hành{" "}
          <span className="font-semibold text-gray-700">"{scheduleName}"</span>?
        </p>

        <div className="flex gap-3">
          <button
            onClick={onClose}
            className="flex-1 rounded-xl bg-gray-100 py-2.5 text-[13px] font-medium text-gray-600"
          >
            Hủy
          </button>
          ...
          <button
            ...
            className="flex-1 rounded-xl bg-red-500 py-2.5 text-[13px] font-semibold text-white disabled:opacity-60"
          >
